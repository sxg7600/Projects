...
public class POS extends JFrame
{
	...
	public POS()
	{
        ...
        int bottomBoxHeight = cmToPixels(5); 
	...
	private void onKeyPadButtonClick(String buttonLabel, JLabel clickedButtonsLabel) 
	{
		...
		else if(buttonLabel.equals("Report") || buttonLabel.equals("Receipt") || buttonLabel.equals("Setting") || buttonLabel.equals("Manager"))
		{
	...
	private void appendTransactionSummary(double subTotal, double tax, double total, double cash, double amountDue) {
		...
		labelAmountDue.setBounds(labelAmountDueX, labelYSummary + 4 * cmToPixels(0.8), amountDueTextWidth, labelAmountDue.getPreferredSize().height);
